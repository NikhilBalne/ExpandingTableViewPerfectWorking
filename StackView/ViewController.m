...
@property (strong) NSArray *sectionItems1,*sectionItems2,*sectionItems3;
...
- (void)viewDidLoad {
    ...
    self.sectionItems1 = @[@"iPhone 5", @"iPhone 5s", @"iPhone 6", @"iPhone 6 Plus", @"iPhone 7", @"iPhone 7 Plus"];
    self.sectionItems2 =  @[@"iPad Mini", @"iPad Air 2", @"iPad Pro", @"iPad Pro 9.7"];
    self.sectionItems3 = @[@"Apple Watch", @"Apple Watch 2", @"Apple Watch 2 (Nike)"];
    self.sectionItems = [NSArray arrayWithObjects:self.sectionItems1,self.sectionItems2,self.sectionItems3, nil];
